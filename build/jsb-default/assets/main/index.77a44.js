...
var i = e("../managers/GameManager"), c = e("../managers/NetworkManager"), s = e("../managers/NetworkConfig"), l = cc._decorator, p = l.ccclass, u = (l.property, 
function(e) {
a(t, e);
function t() {
return null !== e && e.apply(this, arguments) || this;
...
i.GameManager.getInstance().setCurrentDate(o);
}
console.log("isonline data", t);
e.startLoading();
}, function(t, o) {
console.log("isonline error", t, o);
i.GameManager.getInstance().setCurrentDate(cc.sys.localStorage.getItem("rewardClaimDate"));
e.startLoading();
}, !0); else {
...
i.GameManager.getInstance().loadGameConfig().then(function() {
return i.GameManager.getInstance().loadLevels();
}).then(function() {
return i.GameManager.getInstance().loadLanaguge();
}).then(function() {
i.GameManager.getInstance().changeCurrentLanguage();
return i.GameManager.getInstance().loadLevelImages(JSON.parse(cc.sys.localStorage.getItem("lastPlayedLevel")));
}).then(function() {
...
e.prototype.sendRequest = function(e, t, o, n, a, r) {
void 0 === r && (r = !1);
var i = new XMLHttpRequest(), c = this.baseUrl + e;
i.open(t, c);
...
r([ p(cc.Node) ], t.prototype, "overLay", void 0);
return r([ l ], t);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
t.prototype.start = function() {
console.log("date", i.GameManager.getInstance().getCurrentDate());
var e = i.GameManager.getInstance().getCurrentDate().split("-");
if (3 == e.length) {
...
cc.sys.localStorage.setItem("rewardClaimDate", i.GameManager.getInstance().getCurrentDate());
...
r([ l(cc.Label) ], t.prototype, "giftLabel", void 0);
r([ l(cc.Label) ], t.prototype, "clue", void 0);
r([ l(cc.Node) ], t.prototype, "wrappedNode", void 0);
r([ l(cc.Node) ], t.prototype, "claimNode", void 0);
return r([ s ], t);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
var i = e("../helper/constants"), c = e("../managers/GameManager"), s = e("../managers/SoundManager"), l = e("../managers/AdManager"), p = cc._decorator, u = p.ccclass, d = p.property, g = function(e) {
a(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.showingAdFromGp = !1;
...
case i.END_POP_UP.FOR_CLUE:
this.hintLayer.active = !0;
this.isForClue = !0;
this.updatePowerUpTitle();
break;

case i.END_POP_UP.FOR_HIT:
this.hintLayer.active = !0;
this.isForClue = !1;
this.updatePowerUpTitle();
}
...
t += 3;
cc.sys.localStorage.setItem("hint", JSON.stringify(t));
}
this.isForClue = !1;
...
r([ d(cc.Label) ], t.prototype, "remarks", void 0);
r([ d(cc.Label) ], t.prototype, "comments", void 0);
r([ d(cc.Node) ], t.prototype, "newRecord", void 0);
r([ d(cc.Node) ], t.prototype, "timesUp", void 0);
r([ d(cc.Node) ], t.prototype, "hintLayer", void 0);
r([ d(cc.Button) ], t.prototype, "adButtons", void 0);
r([ d(cc.Button) ], t.prototype, "wantHint", void 0);
r([ d(cc.AudioClip) ], t.prototype, "buttonPressed", void 0);
r([ d(cc.Label) ], t.prototype, "powerUpTitle", void 0);
r([ d(cc.Label) ], t.prototype, "powerUpCover", void 0);
return r([ u ], t);
}(cc.Component);
o.default = g;
cc._RF.pop();
...
var i = e("../managers/GameManager"), c = e("../helper/constants"), s = e("../managers/SoundManager"), l = e("../managers/AdManager"), p = {
GROUP_3_4: 0,
GROUP_4_4: 1,
GROUP_4_5: 2,
GROUP_4_6: 3,
...
e.setGrid();
e.startGame();
e.totalTime = e.levelData.timer.totalTime;
...
var e = i.GameManager.getInstance().getLevelData(this._level);
...
for (var e = p["GROUP_" + this._gridInfo.col + "_" + this._gridInfo.row], t = this.containerNode.height - this.gameLayout.spacingX * this._gridInfo.row, o = this.gameLayout.spacingX * this._gridInfo.col, n = this.containerNode.width - o, a = 1, r = 1, i = 0; i < this._cards.length; i++) {
var c = cc.instantiate(this.cardPrefab);
c.getComponent("cards").setDelegate(this);
c.getComponent("cards").setUpUI(this._cards[i].name, this._level, this.gameMode, this.cardsSpriteFrames[e]);
...
this.gameLayout.node.width = this._gridInfo.col * a * r + o;
...
this.isTutoiral && this.showGameInstructionPopUp();
} else {
this.isTouchBlocked = !0;
...
this.gameEndAlert.removeFromParent();
if (i.GameManager.getInstance().getCurrentLevel() == i.GameManager.getInstance().getLevelInfo(this.gameMode).length - 1) {
this.node.parent.getComponent("home").showFutureDetailsScreen();
i.GameManager.getInstance().pushScene(c.GAME_SCREEN.FUTURE_ANNOCMENTS);
} else {
...
this.netError.getComponentInChildren(cc.Label).string = i.GameManager.getInstance().getString("openNet");
...
r([ g(cc.Prefab) ], t.prototype, "cardPrefab", void 0);
r([ g(cc.Prefab) ], t.prototype, "options", void 0);
r([ g(cc.ProgressBar) ], t.prototype, "timerBar", void 0);
r([ g(cc.Layout) ], t.prototype, "gameLayout", void 0);
r([ g(cc.Sprite) ], t.prototype, "bouns", void 0);
r([ g(cc.Prefab) ], t.prototype, "startPopUp", void 0);
r([ g(cc.Prefab) ], t.prototype, "gameEndPopUp", void 0);
r([ g(cc.Node) ], t.prototype, "containerNode", void 0);
r([ g(cc.AudioClip) ], t.prototype, "correctAnswerAudio", void 0);
r([ g(cc.AudioClip) ], t.prototype, "wrongAnswerAudiodFlip", void 0);
r([ g(cc.AudioClip) ], t.prototype, "last5Sec", void 0);
r([ g(cc.AudioClip) ], t.prototype, "clapping", void 0);
r([ g(cc.AudioClip) ], t.prototype, "timesUp", void 0);
r([ g([ cc.SpriteFrame ]) ], t.prototype, "cardsSpriteFrames", void 0);
r([ g(cc.Node) ], t.prototype, "hand", void 0);
r([ g(cc.Node) ], t.prototype, "netError", void 0);
r([ g(cc.Node) ], t.prototype, "gameInstructions", void 0);
return r([ d ], t);
}(cc.Component);
o.default = h;
cc._RF.pop();
...
var n = "";
switch (t) {
case i.GAME_TYPE.FIND:
n = "find";
break;

case i.GAME_TYPE.MIRROR:
n = "mirror";
}
...
r([ p(cc.Label) ], t.prototype, "gameName", void 0);
...
i.GameManager.getInstance().pushScene(c.GAME_SCREEN.HOME);
...
var e = cc.sys.localStorage.getItem("rewardClaimDate"), t = i.GameManager.getInstance().getCurrentDate();
...
this.gameScreen == c.GAME_SCREEN.SETTINGS && i.GameManager.getInstance().popScene();
this.gameScreen == c.GAME_SCREEN.GAME_PLAY && i.GameManager.getInstance().popScene();
this.changeSceneVisiblity(this.gameScreen, !1);
this.gameScreen = c.GAME_SCREEN.LEVEL_SELECTION;
i.GameManager.getInstance().pushScene(c.GAME_SCREEN.LEVEL_SELECTION);
...
var e = i.GameManager.getInstance().getLevelInfo();
...
for (var a = JSON.parse(cc.sys.localStorage.getItem("LevelInfo")), r = 0, c = 0, s = JSON.parse(a.level); c < s.length && s[c].isUnlock; c++) r++;
Math.ceil(r / 10);
...
var e = i.GameManager.getInstance().popScene(), t = i.GameManager.getInstance().popScene();
...
i.GameManager.getInstance().pushScene(t);
console.log("scene arra", i.GameManager.getInstance().screen);
} else {
i.GameManager.getInstance().removeAllScene();
...
this.changeSceneVisiblity(this.gameScreen, !1);
i.GameManager.getInstance().pushScene(c.GAME_SCREEN.GAME_PLAY);
this.gameScreen = c.GAME_SCREEN.GAME_PLAY;
this.levelSelectionNode.active = !1;
this.modeSelectionNode.active = !1;
this.gameplayNode.active = !0;
this.gameplayNode.getComponent("gamePlay").setUpUI(i.GameManager.getInstance().getCurrentLevel());
};
...
var e = JSON.parse(cc.sys.localStorage.getItem("LevelInfo")), t = i.GameManager.getInstance().getLevelInfo().length, o = {
time: 500,
isUnlock: !1
};
if (e.level) {
...
if (n.length < t) {
var a = i.GameManager.getInstance().getLevelInfo().filter(function(e) {
return !n.some(function(t) {
return t.id == e.id;
});
}), r = [];
for (p = 0; p < a.length; p++) r[p] = Object.assign({
id: a[p].id
}, o);
console.log("time ArraY", r);
n.push.apply(n, r);
console.log("time ArraY", n);
} else {
var c = n.filter(function(e) {
return !i.GameManager.getInstance().getLevelInfo().some(function(t) {
return t.id == e.id;
});
});
...
this.isforSetting = !0;
this.gameScreen == c.GAME_SCREEN.LEVEL_SELECTION && i.GameManager.getInstance().popScene();
this.changeSceneVisiblity(this.gameScreen, !1);
this.gameScreen = c.GAME_SCREEN.SETTINGS;
i.GameManager.getInstance().pushScene(c.GAME_SCREEN.SETTINGS);
this.settings.active = !0;
this.hudLayer.zIndex = 8;
console.log(i.GameManager.getInstance().screen);
}
};
...
var e = this, t = i.GameManager.getInstance().getLevelInfo();
this.letloadCount != t.length && i.GameManager.getInstance().loadLevelImages(this.letloadCount).then(function() {
e.letloadCount++;
e.startImageLoading();
}).catch(function() {
...
r([ d(cc.Node) ], t.prototype, "settings", void 0);
r([ d(cc.Node) ], t.prototype, "terms", void 0);
r([ d(cc.Node) ], t.prototype, "dailyRewards", void 0);
r([ d(cc.Node) ], t.prototype, "loader", void 0);
return r([ u ], t);
}(cc.Component);
o.default = g;
cc._RF.pop();
...
var i = e("../managers/SoundManager"), c = cc._decorator, s = c.ccclass, l = c.property, p = function(e) {
a(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.volumeUp = null;
...
i.default.getInstance().playEffect(this.buttonAudio, !1);
...
r([ l(cc.SpriteFrame) ], t.prototype, "volumeUp", void 0);
r([ l(cc.SpriteFrame) ], t.prototype, "volumeDown", void 0);
r([ l(cc.Button) ], t.prototype, "volume", void 0);
r([ l(cc.Label) ], t.prototype, "selectMode", void 0);
r([ l(cc.Button) ], t.prototype, "back", void 0);
r([ l(cc.Button) ], t.prototype, "setting", void 0);
r([ l(cc.Button) ], t.prototype, "level", void 0);
r([ l(cc.AudioClip) ], t.prototype, "backButtonAudio", void 0);
r([ l(cc.AudioClip) ], t.prototype, "buttonAudio", void 0);
return r([ s ], t);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
var i = e("../managers/GameManager"), c = e("../helper/constants"), s = cc._decorator, l = s.ccclass, p = s.property, u = function(e) {
a(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
var t = i.GameManager.getInstance().getLevelData(e);
console.log("level info", t);
this.setLeveltitle(t.gameType, t.groupOf);
this.layout.node.removeAllChildren();
for (var o = i.GameManager.getInstance().getLevelInfo(), n = JSON.parse(cc.sys.localStorage.getItem("LevelInfo")), a = JSON.parse(n.level), r = e + 10 > o.length ? o.length : e + 10, c = e; c < r; c++) {
...
var t = i.GameManager.getInstance().getLevelData(e);
this.setLeveltitle(t.gameType, t.groupOf);
for (var o = JSON.parse(cc.sys.localStorage.getItem("LevelInfo")), n = i.GameManager.getInstance().getLevelInfo(), a = e + 10 > n.length ? n.length : e + 10, r = JSON.parse(o.level), c = e; c < a; c++) {
var s = cc.instantiate(this.levelSelectionButton);
if (r[c].isUnlock) {
s.getChildByName("Background").getComponent("cc.Sprite").spriteFrame = this.unlocked;
s.getChildByName("lock").active = !1;
...
r([ p(cc.Prefab) ], t.prototype, "levelSelectionButton", void 0);
r([ p(cc.SpriteFrame) ], t.prototype, "unlocked", void 0);
r([ p(cc.SpriteFrame) ], t.prototype, "locked", void 0);
r([ p(cc.Layout) ], t.prototype, "layout", void 0);
r([ p(cc.Label) ], t.prototype, "title", void 0);
return r([ l ], t);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
r([ s(cc.Label) ], t.prototype, "hint", void 0);
r([ s(cc.Label) ], t.prototype, "clues", void 0);
r([ s(cc.Button) ], t.prototype, "clueButton", void 0);
return r([ c ], t);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
this.isTerm = !0;
this.header.string = i.GameManager.getInstance().getString("termAndConditions");
this.stringArray = i.GameManager.getInstance().getString("terms");
this.addRemainingLabel();
};
t.prototype.setPrivacy = function() {
this.header.string = i.GameManager.getInstance().getString("privacyPolicyTitle");
this.isTerm = !1;
this.stringArray = i.GameManager.getInstance().getString("privacyInformation");
this.addRemainingLabel();
};
...
r([ p(cc.Label) ], t.prototype, "pLabel", void 0);
r([ p(cc.Label) ], t.prototype, "layout", void 0);
r([ p(cc.Label) ], t.prototype, "header", void 0);
r([ p(cc.AudioClip) ], t.prototype, "buttonPressed", void 0);
return r([ l ], t);
}(cc.Component);
o.default = u;
...
i.default.getInstance().playEffect(this.buttonPressed, !1);
...
r([ l(cc.Node) ], t.prototype, "languagePopUp", void 0);
r([ l(cc.AudioClip) ], t.prototype, "buttonPressed", void 0);
return r([ s ], t);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
}, {}, [ "hud", "options", "LanguageChanger", "localiser", "policy", "dailyRewards", "cards", "gameEnd", "gameFutureDetails", "gamePlay", "gameStart", "constants", "home", "Loading", "tempCodeRunnerFile", "levelUIManager", "AdManager", "FacebookAudiance", "GameManager", "LanguageManager", "NetworkConfig", "NetworkManager", "SoundManager", "settings" ]);