...
t.prototype.showHintPopUP = function() {
...
this.gameEndAlert.getComponent("gameEnd").showPopUpFor(c.END_POP_UP.HINT, this._level);
this.gameEndAlert.active = !0;
clearInterval(this.interval);
} else {
...
l.default.getInstance().setTestDevice("D59E35EC24A739656982C65F234164CB");
...
} else this._delegateScript.showHintPopUP();
}
};
...
this.label2.node.active = !0;
this.label3.node.active = !0;
if (this.isTerm) {
var e = i.GameManager.getInstance().getString("terms1");
this.label.string = e.reduce(function(e, t) {
return e + t;
}, "");
e = i.GameManager.getInstance().getString("terms2");
this.label2.string = e.reduce(function(e, t) {
return e + t;
}, "");
e = i.GameManager.getInstance().getString("terms3");
this.label3.string = e.reduce(function(e, t) {
return e + t;
}, "");
} else {
e = i.GameManager.getInstance().getString("privacyInformation");
this.label.string = e.reduce(function(e, t) {
return e + t;
}, "");
this.label2.node.active = !1;
this.label3.node.active = !1;
}
};
t.prototype.onBack = function() {
...
r([ p(cc.Label) ], t.prototype, "label2", void 0);
r([ p(cc.Label) ], t.prototype, "label3", void 0);
r([ p(cc.AudioClip) ], t.prototype, "buttonPressed", void 0);
return r([ l ], t);
}(cc.Component);
o.default = u;
...
this.privacyPolicy.getComponent("policy").isTerm = !0;
i.default.getInstance().playEffect(this.buttonPressed, !1);
this.privacyPolicy.active = !0;
};
t.prototype.openPrivacyPolicy = function() {
this.privacyPolicy.getComponent("policy").isTerm = !1;
i.default.getInstance().playEffect(this.buttonPressed, !1);
this.privacyPolicy.active = !0;
};
t.prototype.onShare = function() {
...
r([ l(cc.Node) ], t.prototype, "privacyPolicy", void 0);
